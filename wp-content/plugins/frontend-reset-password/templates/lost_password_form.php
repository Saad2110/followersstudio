	...
	<form id="lostpasswordform" method="post" class="account-page-form">
		...
		<fieldset>
			...
			<p class="no-margin">
				...
				<label for="somfrp_user_info"><?php _e( 'Entrez votre e-mail pour obtenir un lien de mot de passe restant.', 'frontend-reset-password' ); ?></label>

				<input type="text" name="somfrp_user_info" id="somfrp_user_info" required autocomplete="username" placeholder="Entrer votre Email">
			...
			<div class="lostpassword-submit">
				<a href="<?=home_url('my-profile');?>" class="lost-pass-cancel">Annuler</a>
